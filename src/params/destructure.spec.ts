describe('Destructuring', () => {
  ...
  describe('with Objects', () => {
    ...
    it('can alias destructured variables', () => {
     ...
     let adress = getAddress();
     let c = adress.city;
     let v = adress.voivodeship;
     let z = adress.zip;
    ...
    it('can destructure nested variables', () => {
      ...
      let adress = getAddress();
      let lat = adress.coords.lat;
      let long = adress.coords.long;
  ...
  describe('combined together', () => {
      ...
      let value = getData();
      let balance = process(value.balance);
      let funds = process(value.funds);
      let incomes = process(value.incomes);
      let payments = process(value.payments);
